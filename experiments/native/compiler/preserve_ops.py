...
@torch.library.custom_op(
    "laya_compiler_exact::layer_norm", mutates_args=(), device_types="cuda"
)
def layer_norm(
    x: torch.Tensor,
    shape: list[int],
...
@torch.library.custom_op(
    "laya_compiler_exact::gelu", mutates_args=(), device_types="cuda"
)
...
@torch.library.custom_op(
    "laya_compiler_exact::attention", mutates_args=(), device_types="cuda"
)
def attention(
