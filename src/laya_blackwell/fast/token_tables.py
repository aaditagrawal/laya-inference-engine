...
def install(model):
    ...
    encoder.register_buffer("fast_token_norm", normalized)
    encoder.register_buffer("fast_token_qkv", projections)
    ...
    replacements = {
        "enc = self.net.encoder": (
            ...
            "        return self.fast_original_forward(input_ids, attention_mask, "
    ...
    model.fast_original_forward = model.forward
